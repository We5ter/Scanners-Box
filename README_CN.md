...
- https://github.com/ASCIT31/Dark-Moon - **Darkmoon（暗月）—— 开源自主式 AI 渗透测试平台，通过 Markdown 剧本与智能体推理编排 80+ 攻击工具，基于 MCP 控制执行，覆盖 Web、云、Active Directory、Kubernetes、API 与内网渗透，并为每个发现提供证据链，模型无关且针对 Claude Opus 优化**
